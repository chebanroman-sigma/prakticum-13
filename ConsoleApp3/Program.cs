...
namespace ConsoleApp3
{
    ...
    {/// <summary>
     /// Задача 6. Дан признак геометрической фигуры на плоскости:
     /// к – круг, п – прямоугольник, т - треугольник. Вывести на 
     /// экран периметр и площадь заданной фигуры (данные, необходимые
     /// для расчетов, запросить у пользователя).
     /// </summary>
